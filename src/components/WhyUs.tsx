...
export default function WhyUs() {
  return (
    <section className="py-10 sm:py-16 bg-[#0f172a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-sm hidden sm:block">
        ...
        <div className="sm:hidden -mx-4 px-4">
          <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white/5 border border-white/10 rounded-2xl p-4 w-56 shrink-0"
              >
                ...
                <p className="text-gray-400 text-xs leading-relaxed line-clamp-3">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Bottom Stats Banner */}
        <div className="mt-8 sm:mt-14 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {[
            ...
            <div
              key={stat.label}
              className="text-center py-4 sm:py-6 px-3 sm:px-4 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl"
            >
              <p className="text-white font-bold text-2xl sm:text-3xl">{stat.value}</p>
              <p className="text-orange-100 text-xs sm:text-sm mt-0.5 sm:mt-1">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
